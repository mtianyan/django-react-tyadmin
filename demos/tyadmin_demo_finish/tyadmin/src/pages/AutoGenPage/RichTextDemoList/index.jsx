          ...
          width: 100,
                              render: (text, record) => (
                                <>
                                  ...
                                  <Popconfirm
                                    title="您确定要删除富文本示例[关联外键，多对多标签]吗？"
                                    placement="topRight"
                                    onConfirm={() => {
                                      handleRemove([record])
  ...
  return (
    <PageHeaderWrapper>
      <ProTable
        ...
        headerTitle="富文本示例[关联外键，多对多标签]表格"
        actionRef={actionRef}
        rowKey="id"
        toolBarRender={(action, { selectedRows }) => [
          ...
          <Button type="primary" onClick={() => exportExcelAll(paramState, queryRichTextDemo, table_columns, '富文本示例[关联外键，多对多标签]-All')}>
            <ExportOutlined /> 导出全部
          </Button>,
          <Input.Search style={{ marginRight: 20 }} placeholder="搜索富文本示例[关联外键，多对多标签]" onSearch={value => {
            setParamState({
              search: value,
            });
                ...
                <Menu
                  onClick={async e => {
                    if (e.key === 'remove') {
                      ...
                      exportExcelCurrent(selectedRows, table_columns, '富文本示例[关联外键，多对多标签]-select')
                    }
                  }}
                  selectedKeys={[]}
                >
